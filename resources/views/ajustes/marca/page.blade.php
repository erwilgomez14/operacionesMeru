        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
            <div class="widget-content-area br-4">
                <div class="widget-one">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <h3>Listado de Marcas de Equipos</h3>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ route('marca.create') }}" class="btn btn-primary btn-lg float-md-right"
                                role="button" aria-pressed="true">Registrar Marca</a>
                        </div>
                            ...
                            @foreach ($marcas as $marca)
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <a class="rounded bs-tooltip" title="Ver" href="{{ route('marca.show', $marca) }}"><i class="far fa-eye"></i><span
                                                class="icon-name"></span></a>

                                        <a class="rounded bs-tooltip" title="Editar" href="{{ route('marca.edit', $marca) }}"><svg
