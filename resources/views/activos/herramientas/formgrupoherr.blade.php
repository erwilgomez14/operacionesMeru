<form action="" method="POST" id="formulario-edicion">
    @csrf
    <h3 class="tittle mt-3 text-center">Edicion del grupo: {{$grupo->id_grupo_herramienta}}</h3>
    <div class="form-group mt-3">
        <label for="nombre_grupo">Nombre del Grupo:</label>
        <input type="text" name="nombre_grupo" class="form-control" data-id="{{ $grupo->id_grupo_herramienta }}"
            id="nombre_grupo" placeholder="nombre" value="{{ $grupo->nombre_grupo }}" required>
    </div>
    ...
    <div class="form-group pt-2">
        <a href="#" class="btn btn-primary" id="btn-actualizar-grupo">Actualizar Grupo</a>
    </div>
</form>
