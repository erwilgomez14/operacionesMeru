                ...
                <div class="widget-one">
                    ...
                    <form method="POST" action="{{route('rol.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre_rol" class="form-control" id="nombre_rol" placeholder="nombre..." value="{{old('nombre_rol')}}" required>
                        </div>
                        <div class="form-group">
                            <label for="rol_slug">Slug</label>
                            <input type="text" name="rol_slug"class="form-control" id="rol_slug" tag="rol_slug" placeholder="slug..." value="{{old('slug')}}" required>
                        </div>
                        <div class="form-group">
                            <label for="rol_permiso">Añadir permisos</label>
                            <input type="text" data-role="tagsinput" name="rol_permiso" class="form-control" id="rol_permiso" value="" >
                        </div>
