            ...
            <div class="widget-content-area br-4">
                <div class="widget-one">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('usuarios.create') }}" class="btn btn-primary btn-lg float-md-right"
                                role="button" aria-pressed="true">Crear Usuario</a>
                        </div>
                            ...
                            @foreach ($usuarios as $usuario)
                                <tr {{ Auth::user()->cedula == $usuario->cedula ? 'bgcolor=#ddd' : '' }}>
                                    ...
                                    <td class="text-center">
                                        <a href="/usuarios/{{ $usuario['cedula'] }}"><i class="far fa-eye"></i><span
                                                class="icon-name"></span></a>

                                        <a href="/usuarios/{{ $usuario['cedula'] }}/edit"><svg
                                        ...
                                        <a href="" class="text-danger" data-toggle="modal"
                                            data-target="#exampleModal" data-userid="{{ $usuario['cedula'] }}"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
