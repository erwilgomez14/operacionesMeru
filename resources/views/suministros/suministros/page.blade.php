        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
            <div class="widget-content-area br-4">
                ...
                <strong>{{session('status')}}</strong>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <h3>Listado de Suministros</h3>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ route('suministros.create') }}" class="btn btn-primary btn-lg float-md-right"
                                role="button" aria-pressed="true">Crear Suministro</a>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- <a href="" title="Eliminar" class="text-danger rounded bs-tooltip"
                                            ...
                                            data-acuid="{{ $suministro['id_suministro'] }}"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
